...
-- Schema cabinet_of_ministers
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `cabinet_of_ministers` DEFAULT CHARACTER SET utf8 ;
USE `cabinet_of_ministers` ;

-- -----------------------------------------------------
-- Table `cabinet_of_ministers`.`cabmin`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cabinet_of_ministers`.`cabmin` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cabinet_of_ministers`.`cabmin_powers` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cabinet_of_ministers`.`user` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cabinet_of_ministers`.`minister` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cabinet_of_ministers`.`committee` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cabinet_of_ministers`.`ministry` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `cabinet_of_ministers`.`legislation` ;
